...
def setup_model_dataset(args):
    if args.dataset == "cifar10":
        ...
        train_full_loader, val_loader, train_idx = cifar10_dataloaders_idx(
        ...
        # print(model)
        return model, train_full_loader, val_loader, test_loader, marked_loader, train_idx
    elif args.dataset == "cifar10withids":
        classes = 10
        normalization = NormalizeByChannelMeanStd(
            mean=[0.4914, 0.4822, 0.4465], std=[0.2470, 0.2435, 0.2616]
        )
        train_full_loader, val_loader, _ = cifar10withids_dataloaders(
            batch_size=args.batch_size, data_dir=args.data, num_workers=args.workers,
            no_aug=args.no_aug,
        )
        marked_loader, _, test_loader = cifar10withids_dataloaders(
            batch_size=args.batch_size,
            data_dir=args.data,
            num_workers=args.workers,
            class_to_replace=args.class_to_replace,
        ...
        train_full_loader, val_loader, train_idx = svhn_dataloaders_idx(
            batch_size=args.batch_size, data_dir=args.data, num_workers=args.workers
        )
    ...
    elif args.dataset == "svhnwithids":
        classes = 10
        normalization = NormalizeByChannelMeanStd(
            mean=[0.4377, 0.4438, 0.4728], std=[0.1201, 0.1231, 0.1052]
        )
        train_full_loader, val_loader, _ = svhnwithids_dataloaders(
            batch_size=args.batch_size, data_dir=args.data, num_workers=args.workers
        )
        marked_loader, _, test_loader = svhnwithids_dataloaders(
            batch_size=args.batch_size,
            data_dir=args.data,
            num_workers=args.workers,
            class_to_replace=args.class_to_replace,
        ...
        train_full_loader, val_loader, train_idx = cifar100_dataloaders_idx(
            batch_size=args.batch_size, data_dir=args.data, num_workers=args.workers,
            no_aug=args.no_aug,
        )
        ...
        train_full_loader, val_loader, _ = cifar100withids_dataloaders(
            batch_size=args.batch_size, data_dir=args.data, num_workers=args.workers,
            no_aug=args.no_aug,
        )
        marked_loader, _, test_loader = cifar100withids_dataloaders(
            batch_size=args.batch_size,
            data_dir=args.data,
            num_workers=args.workers,
            class_to_replace=args.class_to_replace,
        ...
        # print(model)
        return model, train_full_loader, val_loader, test_loader, marked_loader
    elif args.dataset == "TinyImagenetwithids":
        classes = 200
        normalization = NormalizeByChannelMeanStd(
            mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]
        )
        train_full_loader, val_loader, test_loader = TinyImageNetWithID(args).data_loaders(
            batch_size=args.batch_size, data_dir=args.data, num_workers=args.workers,
            no_aug=args.no_aug,
        )
        # train_full_loader, val_loader, test_loader =None, None,None
        marked_loader, _, _ = TinyImageNetWithID(args).data_loaders(
            batch_size=args.batch_size,
            data_dir=args.data,
            num_workers=args.workers,
            class_to_replace=args.class_to_replace,
