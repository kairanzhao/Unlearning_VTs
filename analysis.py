...
def main():
                ...
                if args.unlearn == 'seq_mix':
                    if args.mem_proxy is not None:
                        if args.unlearn_step is None:
                            # filename = (f'{args.unlearn}_FTFTFT_{args.dataset}_{args.arch}_{args.class_to_replace}_num{args.num_indexes_to_replace}_'
    ...
    df_final.to_csv(os.path.join(args.save_dir, f'{args.uname}_{args.dataset}_{args.arch}_TOW_{args.mem_proxy}_{args.unlearn_step}.csv'), index=False)
