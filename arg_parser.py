...
def parse_args():
    ...
    parser.add_argument(
        ...
        "--data", type=str, default="~/Desktop/project/dataset", help="location of the data corpus"
    ...
    parser.add_argument("--save_dir", help="The directory used to save the trained models", default="./assets/checkpoints", type=str,)
